...
const App: React.FC = () => {
	...
	if (!browserSupportsSpeechRecognition) {
		return <span>Votre navigateur ne reconnait pas la reconnaissace vocale</span>;
	}
	...
	return (
		<div className="w-full h-full grid place-items-center">
			<div className="xl:w-[25vw] lg:w-[40vw] md:w-[60vw] w-[90%] flex flex-col shadow-lg bg-white p-5 rounded-lg relative">
				...
				>
					<p>Nombre de caractère: {charCount}</p>
				</div>
				<div className="flex w-full items-center gap-3 mt-5">
					...
					>
						...
						{listening ? "Arreter l'enregistrement" : "Commencer l'enregistrement"}
					</button>
					<button
